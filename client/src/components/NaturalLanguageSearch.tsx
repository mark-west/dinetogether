    ...
    mutationFn: async (searchPrompt: string) => {
      ...
      try {
        ...
        if (error.name === 'AbortError') {
          ...
          // Return a special cancelled state instead of throwing
          return { cancelled: true, restaurants: [] };
        }
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            <Button
              ...
              variant="ghost"
              size="sm"
              className="text-primary-foreground hover:bg-primary-foreground hover:text-primary text-xs transition-colors"
